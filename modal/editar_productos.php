				...
				<div class="modal-body">
					<form class="form-horizontal" method="post" id="editar_producto" name="editar_producto">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<textarea class="form-control" id="mod_nombre" name="mod_nombre"
									placeholder="Nombre del producto" required></textarea>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<textarea class="form-control" id="mod_descripcion" name="mod_descripcion"
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" id="mod_precio" name="mod_precio"
									placeholder="Precio del producto" required pattern="^[0-9]{1,5}(\.[0-9]{0,2})?$"
						...
						<div class="form-group">
							<label for="mod_preciodolares" class="col-sm-3 control-label">Precio en dólares</label>
							<div class="col-sm-8">
								<input type="text" class="form-control" id="mod_preciodolares" name="mod_preciodolares"
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="number" min="0" class="form-control" id="mod_stock" name="mod_stock"
									placeholder="Inventario inicial" required maxlength="8" readonly>
							</div>
						</div>
